...
class PostsManager extends Manager
{
    ...
    {
        $db = $this->connection_to_db();
        $req = "SELECT art.id_article FROM t_article AS art JOIN t_rel_utilisateur_article AS ua ON ua.fk_article=art.id_article JOIN t_utilisateur as ut ON ua.fk_utilisateur=ut.id_utilisateur WHERE ua.fk_article=:id_article AND ua.fk_utilisateur=:id_utilisateur";
        $query = $db->prepare($req);
    ...
    {
        $db = $this->connection_to_db();
        $req = "SELECT id_article FROM t_article AS ar JOIN t_rel_utilisateur_article AS utar ON utar.fk_article=ar.id_article JOIN t_utilisateur AS ut ON utar.fk_utilisateur=ut.id_utilisateur WHERE utar.fk_article=:id_article AND utar.fk_utilisateur=:id_utilisateur";
        $query = $db->prepare($req);
        $query->bindParam(':id_article', $id_article, PDO::PARAM_INT);
        $query->bindParam(':id_utilisateur', $id_utilisateur, PDO::PARAM_INT);
        $query->execute();
    ...
    {
        $db = $this->connection_to_db();
        $req = "INSERT INTO t_rel_article_categorie (fk_article, fk_categorie) VALUES (:id_article, (SELECT id_categorie FROM t_categorie WHERE t_categorie.nom_categorie=:nom_categorie))";
        $query = $db->prepare($req);
    ...
    {
        $db = $this->connection_to_db();
        $req = "INSERT INTO t_rel_article_tags (fk_article, fk_tag) VALUES (:id_article, (SELECT id_tag FROM t_tag WHERE t_tag.nom_tag=:nom_tag))";
        $query = $db->prepare($req);
        $query->bindParam(':nom_tag', $nom_tag, PDO::PARAM_STR);
        $query->bindParam(':id_article', $id_article, PDO::PARAM_INT);
        $query->execute();
    ...
    {
        $db = $this->connection_to_db();
        $req = "INSERT INTO t_rel_utilisateur_article (fk_article, fk_utilisateur) VALUES (:id_article, :id_utilisateur)";
        $query = $db->prepare($req);
        $query->bindParam(':id_article', $id_article, PDO::PARAM_INT);
        $query->bindParam(':id_utilisateur', $id_utilisateur, PDO::PARAM_INT);
        $query->execute();
    ...
    */
    ...
    {
        $db = $this->connection_to_db();
        $req_tags = "SELECT * FROM t_tag AS ta JOIN t_rel_article_tags AS ata ON ata.fk_tag=ta.id_tag JOIN t_article AS ar ON ata.fk_article=ar.id_article WHERE ata.fk_article=:id_article";
    ...
    {
        $db = $this->connection_to_db();
        $req = "DELETE FROM t_rel_article_tags WHERE fk_article=:id_article";
        $query = $db->prepare($req);
        $query->bindParam(':id_article',$id_article,PDO::PARAM_INT);
        $query->execute();
        $query->closeCursor();
    ...
    */
    ...
    {
        $db = $this->connection_to_db();
        $req_categories = "SELECT * FROM t_categorie AS ca JOIN t_rel_article_categorie as aca ON aca.fk_categorie=ca.id_categorie JOIN t_article AS ar ON aca.fk_article= ar.id_article WHERE aca.fk_article=:id_article";
    ...
    {
        $db = $this->connection_to_db();
        $req = "SELECT * FROM t_categorie AS ca JOIN t_rel_article_categorie as aca ON aca.fk_categorie=ca.id_categorie JOIN t_article AS ar ON aca.fk_article= ar.id_article WHERE aca.fk_article=:id_article AND ca.nom_categorie=:nom_categorie";
        $query = $db->prepare($req);
        $query->bindParam(':id_article',$id_article, PDO::PARAM_INT);
    ...
    {
        $db = $this->connection_to_db();
        $req_get_articles = "SELECT id_article, titre_article, auteur_article, extrait_article, contenu_article, DATE_FORMAT(publication_article, '%d/%m/%Y') AS publication_article, couverture_article, slug_article, likes_article FROM t_article AS a JOIN t_rel_article_categorie AS aca ON aca.fk_article=a.id_article JOIN t_categorie as ca ON aca.fk_categorie=ca.id_categorie WHERE ca.nom_categorie=:nom_categorie";
        $query = $db->prepare($req_get_articles);
        $query->bindParam(':nom_categorie', $nom_categorie, PDO::PARAM_STR);
        $query->execute();
    ...
    {
        $db = $this->connection_to_db();
        $req = "DELETE * FROM t_rel_article_categorie WHERE fk_article=:id_article";
        $query = $db->prepare($req);
        $query->bindParam(':id_article',$id_article,PDO::PARAM_INT);
        $query->execute();
        $query->closeCursor();
